...
export const appConfig: ApplicationConfig = {
  providers: [provideZoneChangeDetection({ eventCoalescing: true }), provideRouter(routes), provideNzIcons(icons), provideNzI18n(en_US), importProvidersFrom(FormsModule), provideAnimationsAsync(), provideHttpClient(), provideFirebaseApp(() => initializeApp({"projectId":"app-pokemon-pvc","appId":"1:825271103424:web:eb15d5f7089038c08b2225","storageBucket":"app-pokemon-pvc.appspot.com","apiKey":"AIzaSyBkBQEyzI8oOlCIGrSr530n-5u_IYPL4GU","authDomain":"app-pokemon-pvc.firebaseapp.com","messagingSenderId":"825271103424"})), provideAuth(() => getAuth()), provideFirestore(() => getFirestore()), provideStorage(() => getStorage()),
